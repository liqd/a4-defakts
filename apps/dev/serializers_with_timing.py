...
from apps.dev.decorators import timeit
...
class ModerationCommentSerializer(serializers.ModelSerializer):
    ...
    is_reported_by_ai = serializers.SerializerMethodField()
    is_reported_by_users = serializers.SerializerMethodField()
    ...
    @timeit
    def get_is_reported_by_ai(self, comment):
        return hasattr(comment, "ai_report")

    @timeit
    def get_is_reported_by_users(self, comment):
        return comment.reports.exists()
